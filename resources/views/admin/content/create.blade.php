                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h3><i class="fa fa-sitemap"></i> Add new Content</h3>
                            </div>
                            <!-- end card-header -->
                            <div class="card-body">
                                <div class="card-body">
                                    <form action="{{url('admin/content')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" data-role="tagsinput" name="metaTags" value="{{old('metaTags')}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="metaDescription" class="form-control" maxlength="7000">{{old('metaDescription')}}</textarea>
                                            </div>
                                        </div>
